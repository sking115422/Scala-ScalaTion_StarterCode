...
class Link (name: String, director: Model, from: Vertex, to: Vertex,
      ...
      extends Edge (name, from, prop, to)
         with Statistical (name):

    Link.add (this)

    private val debug     = debugf ("Link", true)                // debug function
    ...
    private val (p1, p2)  = (from.pos(0 to 2), to.pos(0 to 2))   // first and second endpoints
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Jump the entity `SimAgent` down this link.  Place it in the middle
     *  of this link for the entire trip time.
 ...
 */
object Link
       extends EdgeType ("Link", null, VEC ("type"), null, color = black,
                         shape = Arrow ()):
