...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `WaitQueue_LCFS` companion object establishes itself as a `VertexType` and
 *  provides a method of collecting its vertex instances.
 */
object WaitQueue_LCFS
       extends VertexType ("WaitQueue_LCFS", VEC ("type"), color = brown,
                           shape = Rectangle ()):
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Add the queue vertex to the WaitQueue_LCFS vertex type.
     *  @param queue  the queue vertex to add
     */
    def add (queue: WaitQueue_LCFS): Unit =
        debug ("add", s"add vertex $queue to vertex type $WaitQueue_LCFS")
        verts += queue
    end add
    ...
    def group (director: Model, cap: Int = 15,
        ...
        val queueG = new VEC [WaitQueue_LCFS] ()
        for q <- que do queueG += WaitQueue_LCFS (q._1, director, cap, prop,
