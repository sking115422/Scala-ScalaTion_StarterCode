...
object Ex_Teaching:
    ...
    val section = Relation ("section",
        VEC ("crn", "cno", "period1", "period2", "ilname", "seats", "avail"),
...
// MATH            Vector (54438, 4690,  "M W F 09:10 am-10:00 am", Petridis", 6, 0),
     ...
     */
    val ta = Relation ("ta",
        VEC ("lname", "fname", "level", "tep", "hours"),
    ...
    val ta_assign = Relation ("ta_assign",
        VEC ("lname", "fname", "cno", "crn", "hours", "ilname"),
