...
class NullModel (y: VectorD, tt: VectorD = null, hparam: HyperParameter = null)
    ...
    private var mu    = NO_DOUBLE                                      // the relevant sample mean
    private var yf: MatrixD = null                                     // the forecast matrix - time points x horizons

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Return the model name including its current hyper-parameter, e.g., NullModel.
     */
    override def modelName: String = s"NullModel"
    ...
    def train (x_null: MatrixD, y_ : VectorD): Unit = 
        ...
        mu = y(1 to m).mean                                            // record the relevant sample mean (check rSq = 0)
        debug ("train", s"parameters for NullModel model: NA")
    end train

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Test PREDICTIONS of an NullModel forecasting model y_ = f(lags (y_)) + e and return its
    ...
    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Test FORECASTS of an NullModel forecasting model y_ = f(lags (y_)) + e and return its
     *  QoF vector.  Testing may be be in-sample (on the training set) or out-of-sample
     *  (on the testing set) as determined by the parameters passed in.
     *  Note: must call train before test.
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `nullModelTest` main function tests the `NullModel` class on real data: Forecasting lake levels.
