    ...
    class Canvas extends Panel:
        ...
        override def paintComponent (gr: Graphics): Unit =
            ...
            for edge <- graph.edges do
                ...
                for token <- edge.tokens if token.shape.getWidth () > 0.0 do
                    g2d.setPaint (token.color)
                    g2d.fill (token.shape)
                end for
            end for
            ...
            for token <- graph.freeTokens if token.shape.getWidth () > 0.0 do
                g2d.setPaint (token.color)
                g2d.fill (token.shape)
            end for
        end paintComponent
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
/** The `dgAnimatorTest` function is used to test the `DgAnimator` class.
