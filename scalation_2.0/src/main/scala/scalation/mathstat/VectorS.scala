 ...
 *
 *  @title   Vector Data Structure of Strings
 */
...
class VectorS (val dim: Int,
     ...
     */
    def split (idx: IndexedSeq [Int]): (VectorS, VectorS) = (this(idx), not(idx))
    def split (idx: VectorI): (VectorS, VectorS) = { val idx_ = idx.toMuIndexedSeq; (this(idx_), not(idx_)) }
     ...
     */
    def tryCompareTo [B >: VectorS: AsPartiallyOrdered] (bb: B): Option [Int] =
     ...
     *  @param y  the other vector/indexed sequence
     */
    def diff (y: IndexedSeq [String]): VectorS = { val a = v diff y; new VectorS (a.size, a) }

    //::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
    /** Return the intersection of this vector and vector y.
     *  @param y  the other vector/indexed sequence
     */
    def intersect (y: IndexedSeq [String]): VectorS = { val a = v intersect y; new VectorS (a.size, a) }
     ...
     */
    def dot (y: IndexedSeq [String]): String =
        var sum = ""
     ...
     */
    def median (k: Int = (dim+1)/2): String = median (Array.range (0, dim), 0, dim-1, k)
     ...
     */
    def cov (y: IndexedSeq [String]): Double  = this.toDouble cov VectorD.fromStrings (y)
    def cov_ (y: IndexedSeq [String]): Double = this.toDouble cov_ VectorD.fromStrings (y)
     ...
     *  @param y  the other vector
     */
    def corr (y: VectorS): Double = this.toDouble.corr (y.toDouble)
     ...
     *  @param y  the other vector
     */
    def scorr (y: VectorS): Double = this.toDouble.scorr (y.toDouble)
